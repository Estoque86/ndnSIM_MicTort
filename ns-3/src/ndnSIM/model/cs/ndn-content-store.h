...
public:
  ...
  inline void
  ReportHit (Ptr<const Interest> interest, Ptr<const Data> data);
...
inline void
ContentStore::ReportHit (Ptr<const Interest> interest, Ptr<const Data> data)
{
  m_cacheHitsTrace (interest, data);
}
